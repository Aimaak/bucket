...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/register'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/idea/add'), [0 => 'ROLE_USER'], NULL);
