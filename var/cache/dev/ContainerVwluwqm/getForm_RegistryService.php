...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\CategoryType' => function () {
...
}, 'AppBundle\\Form\\IdeaType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\IdeaType']) ? $this->services['AppBundle\Form\IdeaType'] : ($this->services['AppBundle\Form\IdeaType'] = new \AppBundle\Form\IdeaType())) && false ?: '_'};
