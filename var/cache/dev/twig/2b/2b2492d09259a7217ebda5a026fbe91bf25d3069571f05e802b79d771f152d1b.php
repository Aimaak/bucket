...
class __TwigTemplate_895366d8481a93c8170d7b89bf7338643b4eda98187acf37ba134b44c79a7800 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("layout/layout.html.twig", "category/show.html.twig", 1);
        $this->blocks = [
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td>";
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute(($context["category"] ?? $this->getContext($context, "category")), "id", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Name</th>
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 24
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("category_edit", ["id" => $this->getAttribute(($context["category"] ?? $this->getContext($context, "category")), "id", [])]), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";
...
{% endblock %}
", "category/show.html.twig", "C:\\wamp64\\www\\bucket\\app\\Resources\\views\\category\\show.html.twig");
    }
}
