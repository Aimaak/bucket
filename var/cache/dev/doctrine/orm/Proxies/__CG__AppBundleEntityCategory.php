...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'ideas'];
        }
    ...
    public function setIdeas($ideas)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdeas', [$ideas]);

        return parent::setIdeas($ideas);
    }
