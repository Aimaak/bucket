 ...
 */
class Idea extends \AppBundle\Entity\Idea implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Idea' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Idea' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Idea' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Idea' . "\0" . 'author', '' . "\0" . 'AppBundle\\Entity\\Idea' . "\0" . 'isPublished', '' . "\0" . 'AppBundle\\Entity\\Idea' . "\0" . 'dateCreated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Idea $proxy) {
